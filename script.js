...
// const loginIcon = document.querySelector(".fas.fa-user"); // User icon
// const closeLogin = document.getElementById("closeLogin");

// if(loginIcon && loginPopup && closeLogin){
...
function login() {
  ...
  if(username === "admin" && password === "1234") { // change credentials as needed
    alert("Login Successful!");
    isLoggedIn = true;
    loginPopup.style.display = "none";
  } else {
...
document.querySelectorAll(".box").forEach((productBox) => {
  const btn = productBox.querySelector(".cart-btn");
  if (!btn) return;
...
// PLACE ORDER BUTTON
// ----------------------------
const placeOrderBtn = document.getElementById("checkout"); // add this button in your cart popup
if(placeOrderBtn){
  placeOrderBtn.addEventListener("click", () => {
    if(!isLoggedIn){
      alert("Please login first to confirm your order!");
      loginPopup.style.display = "flex";
      return;
    }
    if(cart.length === 0){
